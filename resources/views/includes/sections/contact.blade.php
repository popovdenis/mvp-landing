                ...
                <div class="contact-form-wrapper wow bounceIn" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: bounceIn;">
                    ...
                    <div>
                        ...
                        <form id="contact-form" class="row contact-form contact" action="php/contact.php" method="post">
                            ...
                            <!--begin col-md-6-->
                            <div class="col-md-6">
                                <input class="contact-input" required="" name="contact_name" placeholder="Your Firstname*" type="text">
                            ...
                            <!--begin col-md-6-->
                            <div class="col-md-6">
                                <input class="contact-input" required="" name="contact_name" placeholder="Your Lastname*" type="text">
